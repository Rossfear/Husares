...
{
    public partial class FrmCuadreCajaManual : Form
    {
        string idCaja;
        string id;
        bool editar = false;
        ...
        private void registrar()
        {
            ...
            {
                fn.Modificar("CuadreManual", "NroComprobante='"+txtNroComprobante.Text+ "',Descripcion='"+txtDescripcion.Text+ "',CantidadPollo='"+txtCantidadPollo.Text+ "',GaseosaLitroMedio='"+txtGaseosaLitroMedio.Text+ "',GaseosaMedioLitro='"+txtGaseosaMedioLitro.Text+ "',Agua='"+txtAgua.Text+ "',Monto='"+txtMonto.Text+ "',IDUsuario='"+Datos.idUsuario+"'", "IDCuadre='"+id+"'");
            }
        }
